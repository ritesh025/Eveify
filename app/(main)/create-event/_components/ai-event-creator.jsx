      ...
      <DialogContent>
        ...
        <div className="space-y-4">
          <Textarea
            ...
            placeholder="Example: A creative meetup for art and design lovers in Mumbai. The session will include live sketching, art showcases, and collaborative activities..."
            rows={6}
